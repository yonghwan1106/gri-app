...
export const DATASETS: Dataset[] = [
  ...
  // ── 경기데이터드림 — 유동인구·소비 (가점 5점) ──────────────────────
  {
    id: "gg-floating-population",
    title: "유입 생활이동인구",
    provider: "data.gg.go.kr",
    url: "https://data.gg.go.kr/portal/data/service/selectServicePage.do?infId=Y1HVUV7QPINQ0OG8A1R534987376&infSeq=1",
    categories: ["transit", "safety", "medical"],
    updateCycle: "월",
    lastUpdated: "2026-04-30",
    license: "경기데이터드림 개방데이터",
    format: "Sheet · CSV · File",
    usedFor: "시·군·시간대별 체류·이동 인구 → 응급실 공백·심야 안전 GRI 0.2",
    status: "scheduled",
    fields: ["시군", "행정동", "성별", "연령대", "시간대", "이동인구"],
  },
  {
    id: "gg-card-sales",
    title: "카드매출 행정동 집계",
    provider: "data.gg.go.kr",
    url: "https://data.gg.go.kr/portal/data/service/selectServicePage.do?infId=H92OOSWZXICJM0UO4IHH38259217&infSeq=1",
    categories: ["housing", "safety"],
    updateCycle: "월",
    lastUpdated: "2026-04-30",
    license: "경기데이터드림 개방데이터",
    format: "Sheet · CSV",
    usedFor: "행정동·업종별 소비 패턴 → 상권 침체·생활 안전 GRI 0.15",
    status: "scheduled",
    fields: ["시군", "행정동", "업종", "월", "매출액", "건수"],
  },
